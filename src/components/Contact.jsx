  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form  className='flex flex-col max-w-[600px] w-full'>
            ...
            <input className=' bg-[#ccd6f6] p-2' type="text" placeholder=' Enter you name' name='name' />
            <input className='my-4 p-2 bg-[#ccd6f6]' type="email" placeholder='Enter your email' name='email' />
            <textarea className='bg-[#ccd6f6] p-2' name="message" rows="10" placeholder=' Pass a message'></textarea>
